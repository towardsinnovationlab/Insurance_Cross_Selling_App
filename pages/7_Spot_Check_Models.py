...
LR_C_restored_model = pickle.load(open("https://github.com/towardsinnovationlab/Insurance_Cross_Selling_App/tree/main/LR_C_model_file.pkl", "rb"))
...
# Restore the model from file
KNB_C_restored_model = pickle.load(open("https://github.com/towardsinnovationlab/Insurance_Cross_Selling_App/tree/main/KNB_C_model_file.pkl", "rb"))
...
# Restore the model from file
GNB_C_restored_model = pickle.load(open("https://github.com/towardsinnovationlab/Insurance_Cross_Selling_App/tree/main/GNB_C_model_file.pkl", "rb"))
...
# Restore the model from file
HGBM_C_restored_model = pickle.load(open("https://github.com/towardsinnovationlab/Insurance_Cross_Selling_App/tree/main/HGBM_C_model_file.pkl", "rb"))
