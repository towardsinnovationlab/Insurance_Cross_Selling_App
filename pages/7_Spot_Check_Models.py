...
LR_C_restored_model = pickle.load(open("LR_C_model_file.pkl", "rb"))
...
# Restore the model from file
KNB_C_restored_model = pickle.load(open("KNB_C_model_file.pkl", "rb"))
...
# Restore the model from file
GNB_C_restored_model = pickle.load(open("GNB_C_model_file.pkl", "rb"))
...
# Restore the model from file
HGBM_C_restored_model = pickle.load(open("HGBM_C_model_file.pkl", "rb"))
